...
class CreateEmpresaTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('empresas', function (Blueprint $table) {
            ...
            $table->foreign('tipo_servico')->    references('tipo_servico')->      on('servicos')->       onDelete('CASCADE');
            $table->foreign('telefones')->       references('estab_tel')->     on('telefones')->         onDelete('CASCADE');
            $table->foreign('representante')->   references('represent_nome')->on('represent_contato')->onDelete('CASCADE');
            $table->foreign('estado')->         references('estab_estado')->  on('estab_estado')->     onDelete('CASCADE');
            $table->foreign('cidade')->         references('estab_cidade')->  on('estab_cidade')->     onDelete('CASCADE');
            ...
            $table->foreign('cep')->             references('estab_cep')->     on('ceps')->        onDelete('CASCADE');
            $table->timestamps();
        });
    }
